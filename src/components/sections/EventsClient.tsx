...
const cardItem: Variants = {
  hidden: { opacity: 0, y: 90, rotateY: -18, scale: 0.9, filter: "blur(10px)" },
  visible: {
    opacity: 1,
    y: 0,
    rotateY: 0,
...
export default function EventsClient({ events }: { events: EventCard[] }) {
  ...
  return (
    <section
      id="events"
      className="bg-primary flex items-center justify-center py-8 md:py-10 overflow-hidden"
    >
      <motion.div
